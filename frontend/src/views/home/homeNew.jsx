        ...
        <>
            <div class="relative bg-gradient-to-r from-purple-600 to-blue-600 h-[90vh] text-white overflow-hidden">
                <div class="absolute inset-0">
                    <img src={Group} alt="Background Image" class="object-cover object-center w-full h-[100vh]" />
                ...
                <div class="relative z-10 flex flex-col px-[24px] w-fit mx-auto justify-center items-center h-full text-center">
                    ...
                    <a href="#welcome" class="bg-white text-gray-900 hover:bg-white py-2 px-6 rounded-full text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">Explore</a>
                </div>
            </div>
            ...
            <div class="relative bg-gradient-to-r from-purple-600 to-blue-600  text-white overflow-hidden">
                ...
                <div
                    id="welcome" className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8"
                >
  ...
  <div class="mx-auto grid justify-center gap-4 max-w-screen-xl grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
    <div class="relative overflow-hidden rounded-3xl border bg-gray-100/50 p-2 hover:scale-105 transform translate duration-300">
      <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
        <a href='https://cs.ieeesliit.com/'><img src={CS} className='scale-125' />
        <div class="">
    ...
    <div class="relative overflow-hidden rounded-3xl border bg-gray-100/50 p-2 hover:scale-105 transform translate duration-300">
      ...
      <a href='https://wie.ieeesliit.com/'><img src={WIE} />
        <div class="">
    ...
    <div class="relative overflow-hidden rounded-3xl border bg-gray-100/50 p-2 hover:scale-105 transform translate duration-300">
      <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
      <a href='https://pes.ieeesliit.com/'><img src={PES} />
        <div class="">
    ...
    <div class="relative overflow-hidden rounded-3xl border bg-gray-100/50 p-2  hover:scale-105 transform translate duration-300">
      <div class="flex h-[180px] flex-col justify-between rounded-md p-6 ">
      <a href='https://ras.ieeesliit.com/' ><img src={RAS} />
        <div class="">
    ...
    <div class="relative overflow-hidden rounded-3xl border bg-gray-100/50 p-2 hover:scale-105 transform translate duration-300">
      <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
      <a href='https://ias.ieeesliit.com/'><img src={IAS} />
        <div class="">
