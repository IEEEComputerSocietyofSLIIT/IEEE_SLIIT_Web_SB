import "./style.css";
import CS from "../../images/logos/CS.png";
  ...
  return (
    <>
      ...
      <div class="relative bg-gradient-to-r from-purple-600 to-blue-600  text-white overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/60 sm:bg-transparent sm:from-black/95 sm:to-black/25 ltr:sm:bg-gradient-to-r rtl:sm:bg-gradient-to-l"></div>
        ...
        >
          <div className="max-w-xl text-left ltr:sm:text-left rtl:sm:text-right xl:-ml-[50px]">
            ...
            <p className="mt-4 max-w-lg sm:text-md/relaxed ">
              Since our inception in 2011, It has been one of the most famous
              student chapters in Sri Lanka. Pioneering a variety of projects in
              a variety of fields, including technical projects and community
              service as our student members including seminars and career
              support workshops in science and technical areas and personal
              development programs to improve the productivity of their
              achievements.
            </p>
      ...
      <section
        id="features"
        class="px-[24px] space-y-6 py-8 md:py-12 lg:py-24 max-w-screen-2xl mx-auto"
      >
        <div class="mx-auto flex max-w-screen-2xl flex-col items-center space-y-4 text-center">
          <h1 class="text-4xl sm:text-5xl font-bold leading-tight mb-10">
            IEEE Student Branch Chapters
          </h1>
        </div>
        <div class="mx-auto grid justify-center gap-4 max-w-screen-xl grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
          <div class="relative overflow-hidden rounded-3xl border bg-gray-100/50 p-2 hover:scale-105 transform translate duration-300">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              <a href="https://cs.ieeesliit.com/">
                <img src={CS} className="w-fit h-[146px]" />
                <div class="">
          ...
          <div class="relative overflow-hidden rounded-3xl border bg-gray-100/50 p-2 hover:scale-105 transform translate duration-300">
            <div class="flex h-[180px] flex-col justify-between rounded-lg p-6">
              <a href="https://wie.ieeesliit.com/">
                <img src={WIE} />
                <div class="">
          ...
          <div class="relative overflow-hidden rounded-3xl border bg-gray-100/50 p-2 hover:scale-105 transform translate duration-300">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              <a href="https://pes.ieeesliit.com/">
                <img src={PES} />
                <div class="">
          ...
          <div class="relative overflow-hidden rounded-3xl border bg-gray-100/50 p-2  hover:scale-105 transform translate duration-300">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6 ">
              <a href="https://ras.ieeesliit.com/">
                <img src={RAS} />
                <div class="">
          ...
          <div class="relative overflow-hidden rounded-3xl border bg-gray-100/50 p-2 hover:scale-105 transform translate duration-300">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              <a href="https://ias.ieeesliit.com/">
                <img src={IAS} />
                <div class="">
