...
const Contactus = () => {
  ...
  return (
<section class=" py-5 my-2 mb-5 py-md-6">
  <div class="container">
    <div class="row gy-3 gy-md-4 gy-lg-0 align-items-md-center">
      <div class="col-12 col-lg-6">
        <div class="row justify-content-xl-center">
          <div class="col-12 col-xl-11">
            <h2 class="h2 mb-5 fw-semibold ">Let’s get in touch</h2>
            <p class="lead fs-6 fw-medium text-secondary mb-5">We're always on the lookout to work with new clients. If you're interested in working with us, please get in touch in one of the following ways.</p>
            <div class="d-flex mb-5">
              <div class="me-4 text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#00629b" class="bi bi-geo" viewBox="0 0 16 16">
              ...
              <div>
                ...
                <address class="mb-0 text-secondary fw-medium">IEEE Student Branch of SLIIT,<br/>
            ...
            <div class="row mb-5">
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-5 mb-sm-0">
                  <div class="me-4 text-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#00629b" class="bi bi-telephone-outbound" viewBox="0 0 16 16">
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      <a class="link-secondary text-decoration-none" href="tel:+15057922430">+94 71 995 5200</a>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-0">
                  <div class="me-4 text-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#00629b" class="bi bi-envelope-at" viewBox="0 0 16 16" >
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      <a class="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">Sliit.ieee@gmail.com</a>
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div class=" col-12 col-lg-6">
      <div class="contact border rounded-5 shadow-sm overflow-hidden text-light">
